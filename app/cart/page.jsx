...
const Cart = () => {
  ...
  const { products, route, cartItems, addToCart, updateCartQuantity, getCartCount } = useAppContext();
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20">
        <div className="flex-1">
          ...
          <button onClick={()=> route.push('/all-products')} className="group flex items-center mt-6 gap-2 text-orange-600">
            <Image
